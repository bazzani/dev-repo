/**
 * MWSHierarchyElementFilter.java
 *
...
/**
 * MWSHierarchyElementFilter bean class
 */

public class MWSHierarchyElementFilter implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSHierarchyElementFilter Namespace URI =
	...
	/**
	 * field for ElementInfo
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementInfo localElementInfo;
	 ...
	 */
	protected boolean localElementInfoTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementInfo getElementInfo() {
	...
	public void setElementInfo(
		...
		if (param != null) {
			...
			localElementInfoTracker = true;
		} else {
			localElementInfoTracker = false;

		}

		this.localElementInfo = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSHierarchyElementFilter.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSHierarchyElementFilter",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSHierarchyElementFilter", xmlWriter);
			}

		}
		if (localElementInfoTracker) {
			if (localElementInfo == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"ElementInfo cannot be null!!");
			}
			localElementInfo.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"ElementInfo"), factory, xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localElementInfoTracker) {
			...
			elementList.add(localElementInfo);
		}
		if (localAttributeNameTracker) {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSHierarchyElementFilter parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSHierarchyElementFilter object = new MWSHierarchyElementFilter();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSHierarchyElementFilter".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSHierarchyElementFilter) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"ElementInfo").equals(reader.getName())) {

					object
							.setElementInfo(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementInfo.Factory
									.parse(reader));
