/**
 * MWSObjectInfoPropertySetGroup.java
 *
...
/**
 * MWSObjectInfoPropertySetGroup bean class
 */

public class MWSObjectInfoPropertySetGroup implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSObjectInfoPropertySetGroup Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSObjectInfoPropertySetGroup.this.serialize(parentQName,
						factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSObjectInfoPropertySetGroup",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSObjectInfoPropertySetGroup", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSObjectInfoPropertySetGroup parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSObjectInfoPropertySetGroup object = new MWSObjectInfoPropertySetGroup();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSObjectInfoPropertySetGroup".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSObjectInfoPropertySetGroup) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
