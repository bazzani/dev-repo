...
/**
 * GetReportResults bean class
 */

public class GetReportResults implements org.apache.axis2.databinding.ADBBean {
	...
	protected java.lang.String localSRptID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localSRptIDTracker = false;
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getSRptID() {
		return localSRptID;
	}
	 ...
	 *            SRptID
	 */
	public void setSRptID(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localSRptIDTracker = true;
		} else {
			localSRptIDTracker = false;

		}

		this.localSRptID = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetReportResults.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetReportResults", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetReportResults", xmlWriter);
			}
		...
		if (localSRptIDTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "sRptID", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);

				} else {
					xmlWriter.writeStartElement(namespace, "sRptID");
				}

			} else {
				xmlWriter.writeStartElement("sRptID");
			}
			...
			if (localSRptID == null) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"sRptID cannot be null!!");

			} else {

				xmlWriter.writeCharacters(localSRptID);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localSRptIDTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "sRptID"));

			if (localSRptID != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localSRptID));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"sRptID cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetReportResults parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetReportResults object = new GetReportResults();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetReportResults".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetReportResults) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"sRptID").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setSRptID(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
