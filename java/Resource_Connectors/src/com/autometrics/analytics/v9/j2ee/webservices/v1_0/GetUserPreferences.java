...
/**
 * GetUserPreferences bean class
 */

public class GetUserPreferences implements org.apache.axis2.databinding.ADBBean {
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSUserPreference localPreferences;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSUserPreference getPreferences() {
	...
	public void setPreferences(
		...
		if (param != null) {
			// update the setting tracker
			localPreferencesTracker = true;
		} else {
			localPreferencesTracker = false;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetUserPreferences.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetUserPreferences", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetUserPreferences", xmlWriter);
			}
		...
		if (localPreferencesTracker) {
			...
			localPreferences.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"preferences"), factory, xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetUserPreferences parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetUserPreferences object = new GetUserPreferences();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetUserPreferences".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetUserPreferences) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"preferences").equals(reader.getName())) {

					object
							.setPreferences(com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSUserPreference.Factory
									.parse(reader));
