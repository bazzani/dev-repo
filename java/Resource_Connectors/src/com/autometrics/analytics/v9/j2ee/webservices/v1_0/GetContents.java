...
/**
 * GetContents bean class
 */

public class GetContents implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0", "GetContents", "ns2");
	...
	protected java.lang.String localFolderID;
	 ...
	 *            FolderID
	 */
	public void setFolderID(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localFolderIDTracker = true;
		} else {
			localFolderIDTracker = false;
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjectType localETypes;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localETypesTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjectType getETypes() {
		return localETypes;
	}
	 ...
	 *            ETypes
	 */
	public void setETypes(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjectType param) {

		if (param != null) {
			// update the setting tracker
			localETypesTracker = true;
		} else {
			localETypesTracker = false;

		}

		this.localETypes = param;
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjSubType localESTypes;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localESTypesTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjSubType getESTypes() {
		return localESTypes;
	}
	 ...
	 *            ESTypes
	 */
	public void setESTypes(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjSubType param) {

		if (param != null) {
			// update the setting tracker
			localESTypesTracker = true;
		} else {
			localESTypesTracker = false;

		}

		this.localESTypes = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetContents.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetContents", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetContents", xmlWriter);
			}
		...
		if (localFolderIDTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "folderID", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);

				} else {
					xmlWriter.writeStartElement(namespace, "folderID");
				}

			} else {
				xmlWriter.writeStartElement("folderID");
			}
			...
			if (localFolderID == null) {
				...
				xmlWriter.writeCharacters(localFolderID);

			}

			xmlWriter.writeEndElement();
		}
		if (localETypesTracker) {
			if (localETypes == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"eTypes cannot be null!!");
			}
			localETypes.serialize(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "eTypes"),
					factory, xmlWriter);
		}
		if (localESTypesTracker) {
			if (localESTypes == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"eSTypes cannot be null!!");
			}
			localESTypes.serialize(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "eSTypes"),
					factory, xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localFolderIDTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "folderID"));

			if (localFolderID != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localFolderID));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"folderID cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetContents parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetContents object = new GetContents();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetContents".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetContents) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"folderID").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setFolderID(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"eTypes").equals(reader.getName())) {

					object
							.setETypes(com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjectType.Factory
									.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"eSTypes").equals(reader.getName())) {

					object
							.setESTypes(com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfEnumMWSObjSubType.Factory
									.parse(reader));
