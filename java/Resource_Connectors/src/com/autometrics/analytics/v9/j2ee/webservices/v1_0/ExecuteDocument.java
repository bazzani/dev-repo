...
/**
 * ExecuteDocument bean class
 */

public class ExecuteDocument implements org.apache.axis2.databinding.ADBBean {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				ExecuteDocument.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ExecuteDocument", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ExecuteDocument", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ExecuteDocument parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ExecuteDocument object = new ExecuteDocument();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ExecuteDocument".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ExecuteDocument) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
