...
/**
 * MWSProjectFolderObj bean class
 */

public class MWSProjectFolderObj implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSProjectFolderObj Namespace URI =
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectFolder localFolderType;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectFolder getFolderType() {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSProjectFolderObj.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSProjectFolderObj", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSProjectFolderObj", xmlWriter);
			}
		...
		if (localFolderType == null) {
			throw new org.apache.axis2.databinding.ADBException(
					"FolderType cannot be null!!");
		}
		localFolderType.serialize(new javax.xml.namespace.QName(
				"http://microstrategy.com/webservices/v1_0", "FolderType"),
				factory, xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSProjectFolderObj parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSProjectFolderObj object = new MWSProjectFolderObj();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSProjectFolderObj".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSProjectFolderObj) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"FolderType").equals(reader.getName())) {

					object
							.setFolderType(com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectFolder.Factory
									.parse(reader));
