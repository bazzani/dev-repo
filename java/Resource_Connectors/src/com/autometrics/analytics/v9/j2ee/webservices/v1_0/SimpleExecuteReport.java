...
/**
 * SimpleExecuteReport bean class
 */

public class SimpleExecuteReport implements
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SimpleExecuteReport", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SimpleExecuteReport", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SimpleExecuteReport parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			SimpleExecuteReport object = new SimpleExecuteReport();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SimpleExecuteReport".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (SimpleExecuteReport) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
