...
/**
 * MWSProjectWellKnownObj bean class
 */

public class MWSProjectWellKnownObj implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSProjectWellKnownObj Namespace URI =
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectWellKnownObj localObjectType;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectWellKnownObj getObjectType() {
	...
	public void setObjectType(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectWellKnownObj param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSProjectWellKnownObj.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSProjectWellKnownObj", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSProjectWellKnownObj", xmlWriter);
			}
		...
		localObjectType.serialize(new javax.xml.namespace.QName(
				"http://microstrategy.com/webservices/v1_0", "ObjectType"),
				factory, xmlWriter);
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSProjectWellKnownObj parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSProjectWellKnownObj object = new MWSProjectWellKnownObj();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSProjectWellKnownObj".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSProjectWellKnownObj) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object
							.setObjectType(com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSProjectWellKnownObj.Factory
									.parse(reader));
