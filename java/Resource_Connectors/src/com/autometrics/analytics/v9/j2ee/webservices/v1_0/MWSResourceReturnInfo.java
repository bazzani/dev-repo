...
/**
 * MWSResourceReturnInfo bean class
 */

public class MWSResourceReturnInfo implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSResourceReturnInfo Namespace URI =
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSResourceRequestInfo localRequestInfo;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSResourceRequestInfo getRequestInfo() {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSResourceReturnInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSResourceReturnInfo", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSResourceReturnInfo", xmlWriter);
			}
		...
		if (localRequestInfoTracker) {
			if (localRequestInfo == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"RequestInfo cannot be null!!");
			}
			localRequestInfo.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"RequestInfo"), factory, xmlWriter);
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localRequestInfoTracker) {
			...
			elementList.add(localRequestInfo);
		}
		if (localErrorMsgTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "ErrorMsg"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSResourceReturnInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSResourceReturnInfo object = new MWSResourceReturnInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSResourceReturnInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSResourceReturnInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"RequestInfo").equals(reader.getName())) {

					object
							.setRequestInfo(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSResourceRequestInfo.Factory
									.parse(reader));
				...
				if (reader.isStartElement()
					...
					object
							.setErrorMsg(org.apache.axis2.databinding.utils.ConverterUtil
