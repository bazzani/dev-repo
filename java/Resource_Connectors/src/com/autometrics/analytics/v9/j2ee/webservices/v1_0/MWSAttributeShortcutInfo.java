...
/**
 * MWSAttributeShortcutInfo bean class
 */

public class MWSAttributeShortcutInfo
		extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSShortcutObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSAttributeShortcutInfo Namespace URI =
	...
	/**
	 * field for TargetAttribute
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSAttributeObjectInfo localTargetAttribute;
	 ...
	 */
	protected boolean localTargetAttributeTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSAttributeObjectInfo getTargetAttribute() {
		return localTargetAttribute;
	}
	 ...
	 *            TargetAttribute
	 */
	public void setTargetAttribute(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSAttributeObjectInfo param) {

		if (param != null) {
			// update the setting tracker
			localTargetAttributeTracker = true;
		} else {
			localTargetAttributeTracker = false;

		}

		this.localTargetAttribute = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSAttributeShortcutInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSAttributeShortcutInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSAttributeShortcutInfo", xmlWriter);
		}
		...
		if (localTargetAttributeTracker) {
			if (localTargetAttribute == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetAttribute cannot be null!!");
			}
			localTargetAttribute.serialize(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0",
					"TargetAttribute"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localTargetAttributeTracker) {
			...
			elementList.add(localTargetAttribute);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSAttributeShortcutInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSAttributeShortcutInfo object = new MWSAttributeShortcutInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSAttributeShortcutInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSAttributeShortcutInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetAttribute").equals(reader.getName())) {

					object
							.setTargetAttribute(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSAttributeObjectInfo.Factory
									.parse(reader));
