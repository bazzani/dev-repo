...
/**
 * GetHistory bean class
 */

public class GetHistory implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0", "GetHistory", "ns2");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetHistory", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetHistory", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetHistory parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetHistory object = new GetHistory();
						...
						if (!"GetHistory".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetHistory) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
