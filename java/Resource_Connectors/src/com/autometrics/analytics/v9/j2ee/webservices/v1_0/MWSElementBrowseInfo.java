...
/**
 * MWSElementBrowseInfo bean class
 */

public class MWSElementBrowseInfo implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSElementBrowseInfo Namespace URI =
	...
	/**
	 * field for ElementCollectionInfo
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementCollectionInfo localElementCollectionInfo;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localElementCollectionInfoTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementCollectionInfo getElementCollectionInfo() {
		return localElementCollectionInfo;
	}
	 ...
	 */
	public void setElementCollectionInfo(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementCollectionInfo param) {

		if (param != null) {
			// update the setting tracker
			localElementCollectionInfoTracker = true;
		} else {
			localElementCollectionInfoTracker = false;

		}

		this.localElementCollectionInfo = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSElementBrowseInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSElementBrowseInfo", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSElementBrowseInfo", xmlWriter);
			}
		...
		localStatus.serialize(new javax.xml.namespace.QName(
				...
				factory, xmlWriter);
		if (localElementCollectionInfoTracker) {
			if (localElementCollectionInfo == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"ElementCollectionInfo cannot be null!!");
			}
			localElementCollectionInfo.serialize(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0",
					"ElementCollectionInfo"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localElementCollectionInfoTracker) {
			...
			elementList.add(localElementCollectionInfo);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSElementBrowseInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSElementBrowseInfo object = new MWSElementBrowseInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSElementBrowseInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSElementBrowseInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"ElementCollectionInfo").equals(reader
								.getName())) {

					object
							.setElementCollectionInfo(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSHierarchyElementCollectionInfo.Factory
									.parse(reader));
