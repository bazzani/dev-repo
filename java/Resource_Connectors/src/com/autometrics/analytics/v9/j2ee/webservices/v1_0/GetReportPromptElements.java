...
/**
 * GetReportPromptElements bean class
 */

public class GetReportPromptElements implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0",
			"GetReportPromptElements", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetReportPromptElements.this.serialize(MY_QNAME, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetReportPromptElements", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetReportPromptElements", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetReportPromptElements parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetReportPromptElements object = new GetReportPromptElements();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetReportPromptElements".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetReportPromptElements) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
