...
/**
 * MWSResultsWindow bean class
 */

public class MWSResultsWindow implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSResultsWindow Namespace URI =
	...
	/**
	 * field for PopulatePageBy
	 */

	protected boolean localPopulatePageBy;
	 ...
	 * @return boolean
	 */
	public boolean getPopulatePageBy() {
		return localPopulatePageBy;
	}
	 ...
	 *            PopulatePageBy
	 */
	public void setPopulatePageBy(boolean param) {

		this.localPopulatePageBy = param;

	}

	/**
	 * field for PageBySpecs
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSCurrentElement localPageBySpecs;
	 ...
	 */
	protected boolean localPageBySpecsTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSCurrentElement getPageBySpecs() {
		return localPageBySpecs;
	}
	 ...
	 *            PageBySpecs
	 */
	public void setPageBySpecs(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSCurrentElement param) {

		if (param != null) {
			// update the setting tracker
			localPageBySpecsTracker = true;
		} else {
			localPageBySpecsTracker = false;

		}

		this.localPageBySpecs = param;
	...
	public void serialize(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSResultsWindow", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSResultsWindow", xmlWriter);
			}
		...
		if (!namespace.equals("")) {
			...
			if (prefix == null) {
				...
				xmlWriter
						.writeStartElement(prefix, "PopulatePageBy", namespace);
				xmlWriter.writeNamespace(prefix, namespace);
				xmlWriter.setPrefix(prefix, namespace);

			} else {
				xmlWriter.writeStartElement(namespace, "PopulatePageBy");
			}

		} else {
			xmlWriter.writeStartElement("PopulatePageBy");
		}

		if (false) {

			throw new org.apache.axis2.databinding.ADBException(
					"PopulatePageBy cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localPopulatePageBy));
		}

		xmlWriter.writeEndElement();
		if (localPageBySpecsTracker) {
			if (localPageBySpecs == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"PageBySpecs cannot be null!!");
			}
			localPageBySpecs.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"PageBySpecs"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://microstrategy.com/webservices/v1_0", "PopulatePageBy"));
		...
		if (localPageBySpecsTracker) {
			...
			elementList.add(localPageBySpecs);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSResultsWindow parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSResultsWindow object = new MWSResultsWindow();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSResultsWindow".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSResultsWindow) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"PopulatePageBy").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setPopulatePageBy(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"PageBySpecs").equals(reader.getName())) {

					object
							.setPageBySpecs(com.autometrics.analytics.v9.j2ee.webservices.v1_0.ArrayOfMWSCurrentElement.Factory
									.parse(reader));
