/**
 * MWSObjectInfoPropertySetSpec.java
 *
...
/**
 * MWSObjectInfoPropertySetSpec bean class
 */

public class MWSObjectInfoPropertySetSpec implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSObjectInfoPropertySetSpec Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSObjectInfoPropertySetSpec.this.serialize(parentQName,
						factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSObjectInfoPropertySetSpec",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSObjectInfoPropertySetSpec", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSObjectInfoPropertySetSpec parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSObjectInfoPropertySetSpec object = new MWSObjectInfoPropertySetSpec();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSObjectInfoPropertySetSpec".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSObjectInfoPropertySetSpec) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
