...
public class ArrayOfString implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * ArrayOfString Namespace URI = http://microstrategy.com/webservices/v1_0
					...
					if (localString[i] != null) {
						...
						if (!emptyNamespace) {
							if (prefix == null) {
								...
								xmlWriter
										.writeStartElement(namespace, "string");
							}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localStringTracker) {
			if (localString != null) {
				...
				elementList.add(new javax.xml.namespace.QName(
						"http://microstrategy.com/webservices/v1_0", "string"));
				elementList.add(null);
						...
						if (!"ArrayOfString".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ArrayOfString) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
