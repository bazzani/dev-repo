...
/**
 * ExecuteRSDocument bean class
 */

public class ExecuteRSDocument implements org.apache.axis2.databinding.ADBBean {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				ExecuteRSDocument.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ExecuteRSDocument", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ExecuteRSDocument", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ExecuteRSDocument parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ExecuteRSDocument object = new ExecuteRSDocument();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ExecuteRSDocument".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ExecuteRSDocument) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
