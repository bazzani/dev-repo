...
public class EnumMWSInfoProperty implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0", "EnumMWSInfoProperty",
			"ns2");
	...
	protected java.lang.String localEnumMWSInfoProperty;

	private static java.util.HashMap _table_ = new java.util.HashMap();

	// Constructor

	protected EnumMWSInfoProperty(java.lang.String value,
			boolean isRegisterValue) {
		localEnumMWSInfoProperty = value;
		if (isRegisterValue) {

			_table_.put(localEnumMWSInfoProperty, this);
	...
	public static final EnumMWSInfoProperty MWSBuildVersion = new EnumMWSInfoProperty(
			_MWSBuildVersion, true);

	public static final EnumMWSInfoProperty MWSWSDLVersion = new EnumMWSInfoProperty(
			_MWSWSDLVersion, true);

	public static final EnumMWSInfoProperty MWSReleaseVersion = new EnumMWSInfoProperty(
			_MWSReleaseVersion, true);

	public static final EnumMWSInfoProperty MWSOfficeInstallVersion = new EnumMWSInfoProperty(
			_MWSOfficeInstallVersion, true);

	public static final EnumMWSInfoProperty MWSDashboardVersion = new EnumMWSInfoProperty(
			_MWSDashboardVersion, true);

	public java.lang.String getValue() {
		return localEnumMWSInfoProperty;
	}
	...
	public java.lang.String toString() {
		...
		return localEnumMWSInfoProperty.toString();
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":EnumMWSInfoProperty", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"EnumMWSInfoProperty", xmlWriter);
			}
		}

		if (localEnumMWSInfoProperty == null) {
			...
			xmlWriter.writeCharacters(localEnumMWSInfoProperty);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(
				...
				new java.lang.Object[] {
						...
						org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localEnumMWSInfoProperty) },
				null);
	...
	public static class Factory {
		...
		public static EnumMWSInfoProperty fromValue(java.lang.String value)
				throws java.lang.IllegalArgumentException {
			EnumMWSInfoProperty enumeration = (EnumMWSInfoProperty)
		...
		public static EnumMWSInfoProperty fromString(java.lang.String value,
		...
		public static EnumMWSInfoProperty fromString(
			...
			if (content.indexOf(":") > -1) {
				...
				return EnumMWSInfoProperty.Factory.fromString(content,
						namespaceUri);
			} else {
				return EnumMWSInfoProperty.Factory.fromString(content, "");
			}
		 ...
		 * outer element
		 */
		public static EnumMWSInfoProperty parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			EnumMWSInfoProperty object = null;
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement() || reader.hasText()) {
						...
						if (content.indexOf(":") > 0) {
							...
							object = EnumMWSInfoProperty.Factory.fromString(
