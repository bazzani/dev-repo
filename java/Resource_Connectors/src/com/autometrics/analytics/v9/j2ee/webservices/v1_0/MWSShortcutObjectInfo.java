...
/**
 * MWSShortcutObjectInfo bean class
 */

public class MWSShortcutObjectInfo extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSShortcutObjectInfo Namespace URI =
	...
	/**
	 * field for TargetObjName
	 */

	protected java.lang.String localTargetObjName;
	 ...
	 */
	protected boolean localTargetObjNameTracker = false;
	 ...
	 *            TargetObjName
	 */
	public void setTargetObjName(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localTargetObjNameTracker = true;
		} else {
			localTargetObjNameTracker = false;

		}

		this.localTargetObjName = param;
	...
	protected java.lang.String localTargetObjID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localTargetObjIDTracker = false;
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getTargetObjID() {
		return localTargetObjID;
	}
	 ...
	 *            TargetObjID
	 */
	public void setTargetObjID(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localTargetObjIDTracker = true;
		} else {
			localTargetObjIDTracker = false;

		}

		this.localTargetObjID = param;

	}

	/**
	 * field for TargetObjType
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjectType localTargetObjType;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjectType getTargetObjType() {
		return localTargetObjType;
	}
	 ...
	 *            TargetObjType
	 */
	public void setTargetObjType(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjectType param) {

		this.localTargetObjType = param;

	}

	/**
	 * field for TargetObjSubType
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjSubType localTargetObjSubType;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjSubType getTargetObjSubType() {
		return localTargetObjSubType;
	}
	...
	/**
	 * field for TargetParentFolderID
	 */

	protected java.lang.String localTargetParentFolderID;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localTargetParentFolderIDTracker = false;
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getTargetParentFolderID() {
		return localTargetParentFolderID;
	}
	 ...
	 */
	public void setTargetParentFolderID(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localTargetParentFolderIDTracker = true;
		} else {
			localTargetParentFolderIDTracker = false;

		}

		this.localTargetParentFolderID = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSShortcutObjectInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSShortcutObjectInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSShortcutObjectInfo", xmlWriter);
		}
		...
		if (localTargetObjNameTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "TargetObjName",
							namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);

				} else {
					xmlWriter.writeStartElement(namespace, "TargetObjName");
				}

			} else {
				xmlWriter.writeStartElement("TargetObjName");
			}

			if (localTargetObjName == null) {
				// write the nil attribute

				throw new org.apache.axis2.databinding.ADBException(
						"TargetObjName cannot be null!!");

			} else {

				xmlWriter.writeCharacters(localTargetObjName);

			}

			xmlWriter.writeEndElement();
		}
		if (localTargetObjIDTracker) {
			namespace = "http://microstrategy.com/webservices/v1_0";
			if (!namespace.equals("")) {
				prefix = xmlWriter.getPrefix(namespace);
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "TargetObjID",
							namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);

				} else {
					xmlWriter.writeStartElement(namespace, "TargetObjID");
				}

			} else {
				xmlWriter.writeStartElement("TargetObjID");
			}

			if (localTargetObjID == null) {
				// write the nil attribute

				throw new org.apache.axis2.databinding.ADBException(
						"TargetObjID cannot be null!!");

			} else {

				xmlWriter.writeCharacters(localTargetObjID);

			}

			xmlWriter.writeEndElement();
		}
		if (localTargetObjType == null) {
			throw new org.apache.axis2.databinding.ADBException(
					"TargetObjType cannot be null!!");
		}
		localTargetObjType.serialize(new javax.xml.namespace.QName(
				"http://microstrategy.com/webservices/v1_0", "TargetObjType"),
				factory, xmlWriter);

		if (localTargetObjSubType == null) {
			throw new org.apache.axis2.databinding.ADBException(
					"TargetObjSubType cannot be null!!");
		}
		localTargetObjSubType.serialize(
				new javax.xml.namespace.QName(
						"http://microstrategy.com/webservices/v1_0",
						"TargetObjSubType"), factory, xmlWriter);
		if (localTargetPathTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter
							.writeStartElement(prefix, "TargetPath", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
		...
		if (localTargetParentFolderIDTracker) {
			namespace = "http://microstrategy.com/webservices/v1_0";
			if (!namespace.equals("")) {
				prefix = xmlWriter.getPrefix(namespace);
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "TargetParentFolderID",
							namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
				...
				xmlWriter.writeStartElement("TargetParentFolderID");
			}

			if (localTargetParentFolderID == null) {
				// write the nil attribute

				throw new org.apache.axis2.databinding.ADBException(
						"TargetParentFolderID cannot be null!!");

			} else {

				xmlWriter.writeCharacters(localTargetParentFolderID);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localTargetObjNameTracker) {
			...
			if (localTargetObjName != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localTargetObjName));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetObjName cannot be null!!");
			}
		...
		if (localTargetObjIDTracker) {
			...
			if (localTargetObjID != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localTargetObjID));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetObjID cannot be null!!");
			}
		...
		elementList.add(localTargetObjType);
		...
		elementList.add(localTargetObjSubType);
		if (localTargetPathTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "TargetPath"));

			if (localTargetPath != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localTargetPath));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetPath cannot be null!!");
			}
		...
		if (localTargetParentFolderIDTracker) {
			...
			if (localTargetParentFolderID != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localTargetParentFolderID));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetParentFolderID cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSShortcutObjectInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSShortcutObjectInfo object = new MWSShortcutObjectInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSShortcutObjectInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSShortcutObjectInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetObjName").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setTargetObjName(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetObjID").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setTargetObjID(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetObjType").equals(reader.getName())) {

					object
							.setTargetObjType(com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjectType.Factory
									.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetObjSubType").equals(reader.getName())) {

					object
							.setTargetObjSubType(com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSObjSubType.Factory
									.parse(reader));
				...
				if (reader.isStartElement()
					...
					object
							.setTargetPath(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
				...
				if (reader.isStartElement()
					...
					object
							.setTargetParentFolderID(org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(content));
