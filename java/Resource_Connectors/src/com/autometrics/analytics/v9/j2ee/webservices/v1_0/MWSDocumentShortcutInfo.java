...
/**
 * MWSDocumentShortcutInfo bean class
 */

public class MWSDocumentShortcutInfo
		extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSShortcutObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSDocumentShortcutInfo Namespace URI =
	...
	/**
	 * field for TargetDocument
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSDocumentObjectInfo localTargetDocument;
	 ...
	 */
	protected boolean localTargetDocumentTracker = false;

	/**
	 * Auto generated getter method
	 * 
	 * @return 
	 *         com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSDocumentObjectInfo
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSDocumentObjectInfo getTargetDocument() {
		return localTargetDocument;
	}
	...
	public void setTargetDocument(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSDocumentObjectInfo param) {

		if (param != null) {
			// update the setting tracker
			localTargetDocumentTracker = true;
		} else {
			localTargetDocumentTracker = false;

		}

		this.localTargetDocument = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSDocumentShortcutInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSDocumentShortcutInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSDocumentShortcutInfo", xmlWriter);
		}
		...
		if (localTargetDocumentTracker) {
			if (localTargetDocument == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetDocument cannot be null!!");
			}
			localTargetDocument.serialize(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0",
					"TargetDocument"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localTargetDocumentTracker) {
			...
			elementList.add(localTargetDocument);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSDocumentShortcutInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSDocumentShortcutInfo object = new MWSDocumentShortcutInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSDocumentShortcutInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSDocumentShortcutInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetDocument").equals(reader.getName())) {

					object
							.setTargetDocument(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSDocumentObjectInfo.Factory
									.parse(reader));
