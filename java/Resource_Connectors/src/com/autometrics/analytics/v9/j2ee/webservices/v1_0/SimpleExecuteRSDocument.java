...
/**
 * SimpleExecuteRSDocument bean class
 */

public class SimpleExecuteRSDocument implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0",
			"SimpleExecuteRSDocument", "ns2");
	...
	protected java.lang.String localSDocName;
	 ...
	 * include this field in the serialized XML
	 */
	protected boolean localSDocNameTracker = false;
	 ...
	 */
	public java.lang.String getSDocName() {
		return localSDocName;
	}
	 ...
	 *            SDocName
	 */
	public void setSDocName(java.lang.String param) {

		if (param != null) {
			// update the setting tracker
			localSDocNameTracker = true;
		} else {
			localSDocNameTracker = false;

		}

		this.localSDocName = param;
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSRSSimpleResultFlag localEFormat;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSRSSimpleResultFlag getEFormat() {
		return localEFormat;
	}
	...
	public void setEFormat(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSRSSimpleResultFlag param) {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				SimpleExecuteRSDocument.this.serialize(MY_QNAME, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SimpleExecuteRSDocument", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SimpleExecuteRSDocument", xmlWriter);
			}
		...
		if (localSDocNameTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "sDocName", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);

				} else {
					xmlWriter.writeStartElement(namespace, "sDocName");
				}

			} else {
				xmlWriter.writeStartElement("sDocName");
			}

			if (localSDocName == null) {
				// write the nil attribute

				throw new org.apache.axis2.databinding.ADBException(
						"sDocName cannot be null!!");

			} else {

				xmlWriter.writeCharacters(localSDocName);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localSDocNameTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://microstrategy.com/webservices/v1_0", "sDocName"));

			if (localSDocName != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localSDocName));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"sDocName cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SimpleExecuteRSDocument parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			SimpleExecuteRSDocument object = new SimpleExecuteRSDocument();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SimpleExecuteRSDocument".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (SimpleExecuteRSDocument) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"sDocName").equals(reader.getName())) {

					java.lang.String content = reader.getElementText();

					object
							.setSDocName(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					object
							.setEFormat(com.autometrics.analytics.v9.j2ee.webservices.v1_0.EnumMWSRSSimpleResultFlag.Factory
									.parse(reader));
