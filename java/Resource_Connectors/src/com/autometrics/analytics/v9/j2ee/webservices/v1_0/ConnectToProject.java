...
/**
 * ConnectToProject bean class
 */

public class ConnectToProject implements org.apache.axis2.databinding.ADBBean {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				ConnectToProject.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ConnectToProject", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ConnectToProject", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ConnectToProject parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ConnectToProject object = new ConnectToProject();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ConnectToProject".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ConnectToProject) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
