...
/**
 * DrillReportPromptElement bean class
 */

public class DrillReportPromptElement implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0",
			"DrillReportPromptElement", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				DrillReportPromptElement.this.serialize(MY_QNAME, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":DrillReportPromptElement",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"DrillReportPromptElement", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static DrillReportPromptElement parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			DrillReportPromptElement object = new DrillReportPromptElement();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"DrillReportPromptElement".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (DrillReportPromptElement) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
