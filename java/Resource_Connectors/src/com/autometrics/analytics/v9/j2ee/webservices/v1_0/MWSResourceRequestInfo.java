...
/**
 * MWSResourceRequestInfo bean class
 */

public class MWSResourceRequestInfo implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSResourceRequestInfo Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSResourceRequestInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSResourceRequestInfo", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSResourceRequestInfo", xmlWriter);
			}
		...
		if (localResourceNameTracker) {
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "ResourceName",
							namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
			...
			if (localResourceName != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localResourceName));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"ResourceName cannot be null!!");
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSResourceRequestInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSResourceRequestInfo object = new MWSResourceRequestInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSResourceRequestInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSResourceRequestInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object
							.setResourceName(org.apache.axis2.databinding.utils.ConverterUtil
