...
public class MWSRSDocShortcutInfo
	...
	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSRSDocumentObjectInfo localTargetRSDoc;
	 ...
	 */
	protected boolean localTargetRSDocTracker = false;
	 ...
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSRSDocumentObjectInfo getTargetRSDoc() {
		return localTargetRSDoc;
	}
	 ...
	 *            TargetRSDoc
	 */
	public void setTargetRSDoc(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSRSDocumentObjectInfo param) {

		if (param != null) {
			// update the setting tracker
			localTargetRSDocTracker = true;
		} else {
			localTargetRSDocTracker = false;

		}

		this.localTargetRSDoc = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSRSDocShortcutInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSRSDocShortcutInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSRSDocShortcutInfo", xmlWriter);
		}
		...
		if (localTargetRSDocTracker) {
			if (localTargetRSDoc == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetRSDoc cannot be null!!");
			}
			localTargetRSDoc.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"TargetRSDoc"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localTargetRSDocTracker) {
			...
			elementList.add(localTargetRSDoc);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSRSDocShortcutInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSRSDocShortcutInfo object = new MWSRSDocShortcutInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSRSDocShortcutInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSRSDocShortcutInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetRSDoc").equals(reader.getName())) {

					object
							.setTargetRSDoc(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSRSDocumentObjectInfo.Factory
									.parse(reader));
