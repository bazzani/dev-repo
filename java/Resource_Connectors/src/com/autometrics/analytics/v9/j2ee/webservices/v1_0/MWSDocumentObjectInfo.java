...
/**
 * MWSDocumentObjectInfo bean class
 */

public class MWSDocumentObjectInfo extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSDocumentObjectInfo Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSDocumentObjectInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSDocumentObjectInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSDocumentObjectInfo", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSDocumentObjectInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSDocumentObjectInfo object = new MWSDocumentObjectInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSDocumentObjectInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSDocumentObjectInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName(
										"http://microstrategy.com/webservices/v1_0",
										"ObjModificationTime").equals(reader
										.getName())) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName(
										"http://microstrategy.com/webservices/v1_0",
										"ObjParentFolderID").equals(reader
										.getName())) {
