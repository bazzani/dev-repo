...
/**
 * CancelRSDocument bean class
 */

public class CancelRSDocument implements org.apache.axis2.databinding.ADBBean {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				CancelRSDocument.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":CancelRSDocument", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"CancelRSDocument", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CancelRSDocument parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			CancelRSDocument object = new CancelRSDocument();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"CancelRSDocument".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (CancelRSDocument) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
