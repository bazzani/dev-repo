...
/**
 * CancelDocument bean class
 */

public class CancelDocument implements org.apache.axis2.databinding.ADBBean {
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				CancelDocument.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":CancelDocument", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"CancelDocument", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CancelDocument parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			CancelDocument object = new CancelDocument();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"CancelDocument".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (CancelDocument) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
