/**
 * SimpleGetRSDocumentResults.java
 *
...
/**
 * SimpleGetRSDocumentResults bean class
 */

public class SimpleGetRSDocumentResults implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0",
			"SimpleGetRSDocumentResults", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				SimpleGetRSDocumentResults.this.serialize(MY_QNAME, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SimpleGetRSDocumentResults",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SimpleGetRSDocumentResults", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static SimpleGetRSDocumentResults parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			SimpleGetRSDocumentResults object = new SimpleGetRSDocumentResults();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SimpleGetRSDocumentResults".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (SimpleGetRSDocumentResults) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
