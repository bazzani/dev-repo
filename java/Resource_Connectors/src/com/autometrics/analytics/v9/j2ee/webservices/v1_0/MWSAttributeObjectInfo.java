...
/**
 * MWSAttributeObjectInfo bean class
 */

public class MWSAttributeObjectInfo extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSAttributeObjectInfo Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSAttributeObjectInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSAttributeObjectInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSAttributeObjectInfo", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSAttributeObjectInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSAttributeObjectInfo object = new MWSAttributeObjectInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSAttributeObjectInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSAttributeObjectInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
