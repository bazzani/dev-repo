...
/**
 * MWSReportShortcutInfo bean class
 */

public class MWSReportShortcutInfo
		extends
		com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSShortcutObjectInfo
		implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSReportShortcutInfo Namespace URI =
	...
	/**
	 * field for TargetReport
	 */

	protected com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSReportObjectInfo localTargetReport;
	 ...
	 */
	protected boolean localTargetReportTracker = false;

	/**
	 * Auto generated getter method
	 * 
	 * @return 
	 *         com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSReportObjectInfo
	 */
	public com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSReportObjectInfo getTargetReport() {
		return localTargetReport;
	}
	 ...
	 *            TargetReport
	 */
	public void setTargetReport(
			com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSReportObjectInfo param) {

		if (param != null) {
			// update the setting tracker
			localTargetReportTracker = true;
		} else {
			localTargetReportTracker = false;

		}

		this.localTargetReport = param;
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSReportShortcutInfo.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
	...
	public void serialize(
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":MWSReportShortcutInfo",
					xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "MWSReportShortcutInfo", xmlWriter);
		}
		...
		if (localTargetReportTracker) {
			if (localTargetReport == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"TargetReport cannot be null!!");
			}
			localTargetReport.serialize(
					new javax.xml.namespace.QName(
							"http://microstrategy.com/webservices/v1_0",
							"TargetReport"), factory, xmlWriter);
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localTargetReportTracker) {
			...
			elementList.add(localTargetReport);
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSReportShortcutInfo parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSReportShortcutInfo object = new MWSReportShortcutInfo();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSReportShortcutInfo".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSReportShortcutInfo) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://microstrategy.com/webservices/v1_0",
								"TargetReport").equals(reader.getName())) {

					object
							.setTargetReport(com.autometrics.analytics.v9.j2ee.webservices.v1_0.MWSReportObjectInfo.Factory
									.parse(reader));
