...
/**
 * MWSObjectInfoProperty bean class
 */

public class MWSObjectInfoProperty implements
		org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * MWSObjectInfoProperty Namespace URI =
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				MWSObjectInfoProperty.this.serialize(parentQName, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":MWSObjectInfoProperty", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"MWSObjectInfoProperty", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static MWSObjectInfoProperty parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			MWSObjectInfoProperty object = new MWSObjectInfoProperty();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"MWSObjectInfoProperty".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (MWSObjectInfoProperty) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
