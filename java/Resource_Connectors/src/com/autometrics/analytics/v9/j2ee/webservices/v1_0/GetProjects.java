...
/**
 * GetProjects bean class
 */

public class GetProjects implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0", "GetProjects", "ns2");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetProjects", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetProjects", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetProjects parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetProjects object = new GetProjects();
						...
						if (!"GetProjects".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetProjects) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
