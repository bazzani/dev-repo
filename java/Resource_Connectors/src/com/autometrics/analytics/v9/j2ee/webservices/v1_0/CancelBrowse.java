...
/**
 * CancelBrowse bean class
 */

public class CancelBrowse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0", "CancelBrowse", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				CancelBrowse.this.serialize(MY_QNAME, factory, xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":CancelBrowse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"CancelBrowse", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static CancelBrowse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			CancelBrowse object = new CancelBrowse();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"CancelBrowse".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (CancelBrowse) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
