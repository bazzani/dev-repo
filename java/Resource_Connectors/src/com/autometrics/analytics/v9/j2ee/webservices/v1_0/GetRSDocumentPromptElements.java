/**
 * GetRSDocumentPromptElements.java
 *
...
/**
 * GetRSDocumentPromptElements bean class
 */

public class GetRSDocumentPromptElements implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://microstrategy.com/webservices/v1_0",
			"GetRSDocumentPromptElements", "ns2");
	...
	public org.apache.axiom.om.OMElement getOMElement(
		...
		org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
			...
			public void serialize(
				...
				GetRSDocumentPromptElements.this.serialize(MY_QNAME, factory,
						xmlWriter);
			}
		};
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetRSDocumentPromptElements",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetRSDocumentPromptElements", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetRSDocumentPromptElements parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetRSDocumentPromptElements object = new GetRSDocumentPromptElements();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetRSDocumentPromptElements".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetRSDocumentPromptElements) com.autometrics.analytics.v9.j2ee.webservices.ExtensionMapper
